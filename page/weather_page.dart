...
import 'package:weather/api/request/temp_request.dart';
import 'package:weather/base/resource_model.dart';
import 'package:weather/model/weather_model.dart';
import 'package:weather/repository/temp_repository.dart';
        ...
        child: Container(
          ...
          child: FutureBuilder<ResourceModel<WeatherModel>>(
            ...
            builder: (context, snapshot) {
              ...
              if (snapshot.hasData) {
                return snapshot.data!.when(success: (WeatherModel model) {
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: IconButton(
            ...
            onPressed: () {
              futureWeather =
                  repository.getTempCity(controller.text.toString());
            }),
      ),
    );
  }
